...
![示例状态图](assets/demo_statelang.png)
...
![demo业务流程图](assets/demo_business_process.png)
...
![该json表示的状态图](assets/demo_statelang.png)
...
更多详细的状态语言解释请看[State language referance](http://seata.io/zh-cn/docs/user/saga.html#State-language-referance)章节
...
状态机设计器截图: ![状态机设计器](assets/seata-saga-statemachine-designer.png)
...
- Input: 调用服务的输入参数列表, 是一个数组, 对应于服务方法的参数列表, $.表示使用表达式从状态机上下文中取参数，表达使用的[SpringEL](https://docs.spring.io/spring/docs/4.3.10.RELEASE/spring-framework-reference/html/expressions.html), 如果是常量直接写值即可。复杂的参数如何传入见:[复杂参数的Input定义](http://seata.io/zh-cn/docs/user/saga.html#复杂参数的Input定义)
