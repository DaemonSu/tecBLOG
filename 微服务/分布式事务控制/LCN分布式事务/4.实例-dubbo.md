...
- 工程截图
   ![maven project](http://www.txlcn.org/img/docs/tc_dubbo_project_a.png)
...
- 工程截图
   ![maven project](http://www.txlcn.org/img/docs/tc_dubbo_project_b.png)
- 项目配置文件 application.properties
...
- 工程截图
   ![maven project](http://www.txlcn.org/img/docs/tc_dubbo_project_c.png)
- 项目配置文件 application.properties
...
事务参与方 ServiceB
 ![dubbo-b](http://www.txlcn.org/img/docs/tc_dubbo_b.png) 事务参与方 ServiceC
 ![dubbo-c](http://www.txlcn.org/img/docs/tc_dubbo_c.png) 事务发起方 ServiceA
 ![dubbo-a](http://www.txlcn.org/img/docs/tc_dubbo_a.png)