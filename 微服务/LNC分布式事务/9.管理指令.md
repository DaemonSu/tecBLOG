...
访问 <http://127.0.0.1:7970/admin/index.html>进入管理后台，默认密码时`codingapi`。[指定密码](http://www.txlcn.org/zh-cn/docs/setting/manager.html)

## 后台使用说明

#### 首页信息

主要是TxManager的配置信息，不做特别说明。[注](http://www.txlcn.org/zh-cn/docs/setting/manager.html)
